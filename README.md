...
Для распределения запросов между узлами будем в точках присутствия CDN-серверов будем использовать сервер маршрутизации, хранящий информацию о том, на каких файловых серверах какой контент расположен и осуществляющий балансировку внутри ДЦ. Также должна храниться глобальная таблица с информацией о содержании контента во всех ДЦ. Если определенный контент отсутствует в ближайшем от пользователя ДЦ, по данной таблице определяется ближайший ДЦ, в котором данный контент присутствует.
